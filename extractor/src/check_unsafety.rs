...
// https://raw.githubusercontent.com/rust-lang/rust/c58e09f138075ce6b3079f41f9c2f192a15b896c/src/librustc_mir/transform/check_unsafety.rs
//
...
pub struct UnsafetyChecker<'a, 'tcx> {
    ...
    fn_uses_unsafe: bool,
    fn_unsafe_reasons: Vec<&'static str>,
}
...
impl<'a, 'tcx> UnsafetyChecker<'a, 'tcx> {
    fn require_unsafe(
        ...
        if !self.fn_unsafe_reasons.contains(&description) {
            self.fn_unsafe_reasons.push(description);
        }
        let source_info = self.source_info;
...
pub(crate) fn unsafety_check_result(tcx: TyCtxt<'_>, def_id: DefId) -> (bool, Vec<&'static str>) {
    ...
    (checker.fn_uses_unsafe, checker.fn_unsafe_reasons)
}
